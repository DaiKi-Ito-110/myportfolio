...
import WDSImg9 from '/src/assets/images/waterDropletSculpture/detail9.webp'
...
export const workInfo = [
  {
    ...
    year: '2023',
    detailImgs: [WDSImg1, WDSImg2, WDSImg3, WDSImg4, WDSImg5, WDSImg6, WDSImg7, WDSImg8, WDSImg9],
